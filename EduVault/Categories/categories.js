document.addEventListener('DOMContentLoaded', function () {
    ...
    const newReleaseBooks = [
        ...
        { title: 'Analisa Studi Kelayakan WebsiteDinas Kebudayaan Provinsi Riau Menggunakan Metode TELOS', author: 'Roby Ramadani', img: '/EduVault/jurnal/B.png', pdf:'/EduVault/jurnal/2.pdf' },
        { title: 'Penilaian KualitasQuality of Service Jaringan Internet WLAN PT. Solid Fintek', author: 'IndonesiaMuhammad Rizky', img: '/EduVault/jurnal/C.png', pdf:'/EduVault/jurnal/3.pdf' },
        ...
        { title: 'Penerapanan Model Deteksi Objek Untuk Robot Menggunakan Model SSD Di Lingkungan Simulasi ROS', author: 'Ilham Rizqyakbar', img: '/EduVault/jurnal/E.png', pdf:'/EduVault/jurnal/5.pdf' },
        { title: 'Rancang Bangun Aplikasi Manajemen Kos Menggunakan Framework Flutter', author: 'Daris Irfan Putrawanto', img: '/EduVault/jurnal/F.png', pdf:'/EduVault/jurnal/6.pdf' }
    ];
